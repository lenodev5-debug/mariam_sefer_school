...
const bookData = [
  ...
  },
  {
    ...
    rating: 4.8,
    description: 'The story of racial injustice and the loss of innocence in the Deep South.',
    image: book1,
  },
  {
    id: 3,
    ...
    >
      ...
      {showDetail && (
        <div className="border-t border-white/10 bg-black/30 p-3 animate-[fadeIn_0.2s_ease-in-out]">
          <p className="text-[11px] leading-relaxed text-gray-300">{book.description}</p>
